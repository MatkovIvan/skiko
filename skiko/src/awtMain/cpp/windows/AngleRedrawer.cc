...
extern "C"
{
    JNIEXPORT jlong JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_createAngleDevice(
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_makeCurrent(
    ...
    JNIEXPORT jlong JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_makeAngleContext(
        JNIEnv *env, jobject redrawer, jlong devicePtr)
    {
        AngleDevice *angleDevice = fromJavaPointer<AngleDevice *>(devicePtr);
    ...
    JNIEXPORT jlong JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_makeAngleRenderTarget(
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_swapBuffers(
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_redrawer_AngleRenderContext_disposeDevice(
        JNIEnv *env, jobject redrawer, jlong devicePtr)
    {
        AngleDevice *angleDevice = fromJavaPointer<AngleDevice *>(devicePtr);
