...
val RenderContext.direct3DAdapterPointer: Long?
    get() = (this as? Direct3DContextHandler)?.direct3DAdapterPtr
...
val RenderContext.direct3DDevicePointer: Long?
    get() = (this as? Direct3DContextHandler)?.direct3DDevicePtr
...
val RenderContext.direct3DQueuePointer: Long?
    get() = (this as? Direct3DContextHandler)?.direct3DQueuePtr
